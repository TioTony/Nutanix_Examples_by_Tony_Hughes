...
def main():
    ...
    endpoint = f"https://{CLUSTER_IP}:{CLUSTER_PORT}/PrismGateway/services/rest/v2.0/vms/c1825b64-0fde-4dff-af44-02f68ed4c86b?include_vm_disk_config=true&include_vm_nic_config=true"
