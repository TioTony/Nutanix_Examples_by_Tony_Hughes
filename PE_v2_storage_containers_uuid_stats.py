...
def main():
    ...
    endpoint = f"https://{CLUSTER_IP}:{CLUSTER_PORT}/PrismGateway/services/rest/v2.0/storage_containers/d71a99c6-7e85-4554-9b72-12fc89b90c5a/stats/?metrics=data_reduction.clone.saving_ratio_ppm/"
