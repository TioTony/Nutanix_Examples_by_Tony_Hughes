...
def main():
    ...
    endpoint = f"https://{CLUSTER_IP}:{CLUSTER_PORT}/PrismGateway/services/rest/v2.0/volume_groups/e3b8e7e7-1d4f-412f-ac41-0d4c10a35b2b?include_disk_size=true&include_disk_path=true"
