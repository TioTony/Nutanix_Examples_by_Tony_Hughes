...
def main():
    ...
    endpoint = f"https://{CLUSTER_IP}:{CLUSTER_PORT}/PrismGateway/services/rest/v2.0/cloud/nutanix/cvms"
    ...
    try:
        ...
        print("Need to revisit this one, I think it only works for Clusters on Public Cloud")
