...
def main():
    ...
    endpoint = f"https://{PC_IP}:{PC_PORT}/api/nutanix/v3/network_security_rules/export"
    request_headers = {"Content-Type": "application/octet-stream", "charset": "utf-8"}
    request_body = {}
    print(f"Tony NOTE: Need to revisit this, the output is octet stream not json")
