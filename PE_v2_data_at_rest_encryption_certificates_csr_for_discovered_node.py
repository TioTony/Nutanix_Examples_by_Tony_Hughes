...
def main():
    ...
    endpoint = f"https://{CLUSTER_IP}:{CLUSTER_PORT}/PrismGateway/services/rest/v2.0/data_at_rest_encryption_certificates/csr_for_discovered_node/"
    request_headers = {"Content-Type": "application/json", "charset": "utf-8"}
    # request_body = {"kind": "vm", "length": 5}
    request_body = {"node_ip": "10.0.0.133"}
