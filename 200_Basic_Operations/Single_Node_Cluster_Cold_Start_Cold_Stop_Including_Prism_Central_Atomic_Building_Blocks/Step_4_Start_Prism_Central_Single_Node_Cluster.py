"""
Start Prism Central once the cluster is running.
This script DOES NOT verify if the cluster is running first.
I only tested this with a single Prism Central, not a scale-out Prism Central.
"""
import json
import os
import sys
