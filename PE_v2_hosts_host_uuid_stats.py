...
def main():
    ...
    endpoint = f"https://{CLUSTER_IP}:{CLUSTER_PORT}/PrismGateway/services/rest/v2.0/hosts/ad3d5637-690b-4693-af55-31dd18fc0b77/stats/?metrics=storage_tier.ssd.capacity_bytes"
