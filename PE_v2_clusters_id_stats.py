...
def main():
    ...
    endpoint = f"https://{CLUSTER_IP}:{CLUSTER_PORT}/PrismGateway/services/rest/v2.0/clusters/0005c241-2fef-5fda-020d-ac1f6b775ed0/stats"
    ...
    try:
        ...
        print("Need to revisit, could not figure out the metrics to query from docs, nutanix.dev, or slack")
