...
def main():
    ...
    endpoint = f"https://{CLUSTER_IP}:{CLUSTER_PORT}/PrismGateway/services/rest/v2.0/virtual_disks/f1845ed8-b48e-4561-9349-d357f1d0d7d3/stats/?metrics=controller.storage_tier.ssd.usage_bytes"
