...
def main():
    ...
    # ID is the cluster_uuid which can be found from the "cluster" or "clusters" api
    # This example uses the cluster ID of the SuperNUC
    endpoint = f"https://{CLUSTER_IP}:{CLUSTER_PORT}/PrismGateway/services/rest/v2.0/data_at_rest_encryption_certificates/csrs/"
    request_headers = {"Content-Type": "application/json", "charset": "utf-8"}
    # request_body = {"kind": "vm", "length": 5}
    # This is the node_uuid obtained from the clusters api for SuperNUC
    request_body = {"node_uuid_list": "ad3d5637-690b-4693-af55-31dd18fc0b77"}
