...
def main():
    ...
    endpoint = f"https://{CLUSTER_IP}:{CLUSTER_PORT}/PrismGateway/services/rest/v2.0/protection_domains/ERA_MYSQL_OOB_single_f2151c1d_centos_7.4_mysql_8.0/schedules/"
